			...
			{!! Form::open(['route' => 'aspek.store']) !!}
				<div class="panel-body">
					<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
						...
						{{ Form::textarea('name', null, ['class' => 'form-control', 'placeholder' => 'Nama aspek', 'autocomplete' => 'off']) }}
					...
					<div class="form-group {{ $errors->has('kompetensi') ? 'has-error' : '' }}">
						...
						{{ Form::select('kompetensi', $kompetensis, null, ['id' => 'kompetensi', 'class' => 'form-control', 'placeholder' => 'Pilih kompetensi']) }}
